...
class TkinterDisplay(BaseDisplay):
    """Tkinter-based GUI display for the rover basestation."""
    ...
    def _match_by_type(self, data, controller_values_copy):
        """Match controller values using the explicit 'type' field in data."""
    ...
    def _match_by_detection(self, controller_name, controller_values_copy):
        """Match controller values using centralized controller type detection."""
    ...
    def _match_by_fuzzy_name(self, controller_name, controller_values_copy):
        """Match controller values using fuzzy substring matching on names."""
