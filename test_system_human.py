...
class XBeeSystemTester:
    ...
    def test_constants_and_enums(self):
        ...
        try:
            ...
            print("[OK] Timing constants defined correctly")
            ...
            print("[OK] Communication constants defined correctly")
            ...
            print("[OK] Controller mode constants defined correctly")
            ...
            print("[OK] Heartbeat message constant defined correctly")
    ...
    def test_heartbeat_system(self):
        ...
        try:
            ...
            if len(message) == 3 and message[0:1] == CONSTANTS.HEARTBEAT.MESSAGE:
                print("[OK] Heartbeat message structure correct")
            else:
                print("[FAIL] Heartbeat message structure incorrect")
                return False
                
            # Test timing intervals (short)
            print("Running 3-second timing test...")
            tester.test_interval_timing(3)
            print("[OK] Heartbeat timing test completed")
            ...
            print(f"[OK] Sent {sent_count} heartbeats with mock XBee")
    ...
    def test_controller_state_management(self):
        ...
        try:
            ...
            print("[OK] Initial controller state loaded correctly")
            ...
            if updated_value == CONSTANTS.XBOX.BUTTONS.ON:
                print("[OK] Controller state updates working")
            else:
                print("[FAIL] Controller state update failed")
                return False
                
            return True
            
        except Exception as e:
            print(f"[FAIL] Controller state test failed: {e}")
            return False
    ...
    def test_message_formatting(self):
        ...
        try:
            ...
            print("[OK] Xbox message formatting working")
            ...
            print("[OK] N64 message formatting working")
            ...
            print(f"[FAIL] Message formatting test failed: {e}")
            return False
    ...
    def test_communication_manager(self):
        ...
        try:
            ...
            if result:
                print("[OK] Controller data transmission successful")
                # Verify send_data was called
                mock_xbee.send_data.assert_called()
            else:
                print("[FAIL] Controller data transmission failed")
                return False
                
            # Test quit message
            quit_result = comm_manager.send_quit_message()
            if quit_result:
                print("[OK] Quit message transmission successful")
            else:
                print("[FAIL] Quit message transmission failed")
                return False
            
            # Test compact messages
            result = comm_manager.send_compact_message([0xCA, 0x01])
            if result:
                print("[OK] Compact message transmission successful")
            else:
                print("[FAIL] Compact message transmission failed")
                return False
            
            # Test heartbeat with custom timestamp
            result = comm_manager.send_heartbeat(1234)
            if result:
                print("[OK] Heartbeat with timestamp successful")
            else:
                print("[FAIL] Heartbeat with timestamp failed")
                return False
                
            return True
            
        except Exception as e:
            print(f"[FAIL] Communication manager test failed: {e}")
            return False
    ...
    def test_simulation_mode(self):
        ...
        try:
            ...
            if reconstructed.message_type == "test_type" and reconstructed.data == msg_data:
                print("[OK] UDP message serialization working")
            else:
                print("[FAIL] UDP message serialization failed")
                return False
            ...
            if hasattr(sim_manager, 'send_controller_data') and hasattr(sim_manager, 'get_statistics'):
                print("[OK] SimulationCommunicationManager interface correct")
            else:
                print("[FAIL] SimulationCommunicationManager missing expected methods")
                return False
            
            # Test statistics
            stats = sim_manager.get_statistics()
            if isinstance(stats, dict):
                print("[OK] Statistics retrieval working")
            else:
            ...
            print(f"[FAIL] Simulation mode test failed: {e}")
            return False
    ...
    def test_compact_messages(self):
        ...
        try:
            ...
            if result:
                print("[OK] send_status_update working")
            else:
                print("[FAIL] send_status_update failed")
                return False
            
            # Test send_error_code
            result = comm_manager.send_error_code(42, 1)
            if result:
                print("[OK] send_error_code working")
            else:
                print("[FAIL] send_error_code failed")
                return False
            
            # Test send_gps_position
            result = comm_manager.send_gps_position(40.7128, -74.0060)
            if result:
                print("[OK] send_gps_position working")
            else:
                print("[FAIL] send_gps_position failed")
                return False
            
            # Test send_sensor_reading
            result = comm_manager.send_sensor_reading(5, 1234)
            if result:
                print("[OK] send_sensor_reading working")
            else:
                print("[FAIL] send_sensor_reading failed")
                return False
            
            return True
            
        except Exception as e:
            print(f"[FAIL] Compact message test failed: {e}")
            return False
    ...
    def test_integration(self):
        ...
        try:
            ...
            if not stored or not isinstance(stored, (bytes, bytearray)):
                print("[FAIL] ControllerManager/InputProcessor did not update state as expected")
                return False
            ...
            if not (manager.reverse_mode and manager.creep_mode):
                print("[FAIL] Mode flags not set by ControllerManager.update_mode_flags")
                return False
